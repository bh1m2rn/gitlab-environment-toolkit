module "redis" {
  ...
  iam_instance_profile = try(coalesce(var.redis_iam_instance_profile, var.default_iam_instance_profile), null)
...
module "redis_cache" {
  ...
  subnet_ids           = local.subnet_ids
  iam_instance_profile = try(coalesce(var.redis_cache_iam_instance_profile, var.default_iam_instance_profile), null)
...
module "redis_persistent" {
  ...
  subnet_ids           = local.subnet_ids
  iam_instance_profile = try(coalesce(var.redis_persistent_iam_instance_profile, var.default_iam_instance_profile), null)
