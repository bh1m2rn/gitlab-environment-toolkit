module "gitlab_nfs" {
  ...
  disk_disk_delete_on_termination = var.gitlab_nfs_disk_disk_delete_on_termination != null ? var.gitlab_nfs_disk_disk_delete_on_termination : var.default_disk_disk_delete_on_termination
