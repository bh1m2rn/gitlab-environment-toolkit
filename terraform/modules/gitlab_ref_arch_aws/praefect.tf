module "praefect" {
  ...
  disk_disk_delete_on_termination = var.praefect_disk_disk_delete_on_termination != null ? var.praefect_disk_disk_delete_on_termination : var.default_disk_disk_delete_on_termination
