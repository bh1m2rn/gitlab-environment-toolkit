module "praefect_postgres" {
  ...
  disk_disk_delete_on_termination = var.praefect_postgres_disk_disk_delete_on_termination != null ? var.praefect_postgres_disk_disk_delete_on_termination : var.default_disk_disk_delete_on_termination
