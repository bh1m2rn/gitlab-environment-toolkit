module "gitlab_rails" {
  ...
  disk_disk_delete_on_termination = var.gitlab_rails_disk_disk_delete_on_termination != null ? var.gitlab_rails_disk_disk_delete_on_termination : var.default_disk_disk_delete_on_termination
