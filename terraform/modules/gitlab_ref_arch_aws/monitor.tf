module "monitor" {
  ...
  disk_disk_delete_on_termination = var.monitor_disk_disk_delete_on_termination != null ? var.monitor_disk_disk_delete_on_termination : var.default_disk_disk_delete_on_termination
