module "sidekiq" {
  ...
  disk_disk_delete_on_termination = var.sidekiq_disk_disk_delete_on_termination != null ? var.sidekiq_disk_disk_delete_on_termination : var.default_disk_disk_delete_on_termination
